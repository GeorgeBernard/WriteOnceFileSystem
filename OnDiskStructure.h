...
typedef struct metaData {
	...
	int type;            // indicates file or directory 0 - file 1 - directory
	long length;         // for file the length of the file in bytes, for directory the number of sub files/directories
	unsigned long time;  // The time of access in UNIX time - saved as an unsigned long
	metadata* p;         // Pointer to either the start of the file or the subfiles/directories
